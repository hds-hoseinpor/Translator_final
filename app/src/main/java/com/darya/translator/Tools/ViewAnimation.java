...
public class ViewAnimation {
    ...
    public static void expand(final View v, int duration) {
        Animation a = expandAction(v, duration);
        v.startAnimation(a);
    }
    ...
    public static void alphaAnimation(final boolean hide, View view, float alpha_true, float alpha_false, int duration, int startDelay) {
        float alpha = hide ? alpha_true : alpha_false;
        view.animate().alpha(alpha).setStartDelay(startDelay).setDuration(duration).start();
    }
    ...
    private static Animation expandAction(final View v, int duration) {
        v.measure(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
        final int targtetHeight = v.getMeasuredHeight();
        v.getLayoutParams().height = 0;
        v.setVisibility(View.VISIBLE);
